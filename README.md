...
This plugin is expansion of the project [madplay/Mad-jEnv](https://github.com/madplay/Mad-jEnv.git)
...
- Manually:
  ...
  Download the [latest release](https://github.com/JokingAboutLife/idea-plugin-demo/releases/latest) and install it manually using
